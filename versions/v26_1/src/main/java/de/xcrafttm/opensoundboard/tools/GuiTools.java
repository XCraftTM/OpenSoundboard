...
public final class GuiTools {
    ...
    public static Component favoriteLabel(boolean fav) {
        return Component.literal(fav ? "★" : "☆").withStyle(fav ? ChatFormatting.GOLD : ChatFormatting.GRAY);
    }

    public static Component loopLabel(boolean loopAll) {
        return Component.literal(loopAll ? "🔁" : "🔄")
                .withStyle(loopAll ? ChatFormatting.WHITE : ChatFormatting.GRAY);
    }
    ...
    public static Component keyBindLabel(@Nullable SoundboardConfig.KeyBind keyBind) {
        ...
        Component keyName = (Component) InputUtil.fromKeyCode(new KeyInput(keyBind.getKeyCode(), keyBind.getScanCode(), keyBind.getModifiers()))
                .getLocalizedText();
        ...
        return Component.translatable("gui.opensoundboard.keybind.prefix").append(String.valueOf(fullText));
    }
}
